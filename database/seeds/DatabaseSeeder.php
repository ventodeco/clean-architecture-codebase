...
class DatabaseSeeder extends Seeder
{
    ...
    public function seed_admin_feature()
    {
        ...
        // Users
        $melardev = \App\Domains\UserRole\Models\User::firstOrCreate(
    ...
    public function seed_addresses()
    {
        ...
        if ($addresses_to_seed > 0) {
            ...
            factory(\App\Domains\Address\Models\Address::class, $addresses_to_seed)
                ->create()
                ->each(function ($address) {
                    // $order->user()->save(new \App\Domains\Address\Models\Address([]));
                });
        }
    }
